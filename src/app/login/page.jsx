  ...
  return (
    ...
    <section className="texto-login">
        <div className='logo-porto-login'>
            <Link href="/"><Image src="/logotipo1.svg" alt="Logotipo Porto Seguro-SOS" width={320} height={320}></Image></Link>
        </div>
    ...
    <section className='foto-guincho'>
      <div className='div-foto-guincho'>
        <Image src="/guincho.svg" alt="Imagem ilustrando um guincho da porto seguro saindo da tela de um celular" width={320} height={320}></Image>
      </div>
    </section>
  </main>
  )
